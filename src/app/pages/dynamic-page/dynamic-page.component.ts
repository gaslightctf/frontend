...
export class DynamicPageComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.updatePagesSubscription = this.dataService.pages.subscribe((pages) =>
      this.handlePagesUpdate(pages),
    );
    this.updateRouteSubscription = this.router.events.subscribe((event) =>
      this.handleUpdate(),
    );
  }
